Pod::Spec.new do |s|
  ...
  s.source           =  { :git => 'https://github.com/deberle/RestKit.git', :tag => "v#{s.version}" }
...
EOS
  ...
  s.subspec 'Core' do |cs|
    cs.dependency 'IG_RestKit/ObjectMapping'
    cs.dependency 'IG_RestKit/Network'
    cs.dependency 'IG_RestKit/CoreData'
  end

  s.subspec 'ObjectMapping' do |os|
    os.source_files   = 'Code/ObjectMapping.h', 'Code/ObjectMapping'
    os.dependency       'IG_RestKit/Support'
  ...
  s.subspec 'Network' do |ns|
    ...
    ns.dependency       'IG_RestKit/ObjectMapping'
    ns.dependency       'IG_RestKit/Support'
...
EOS
  ...
  s.subspec 'CoreData' do |cdos|
    ...
    cdos.dependency 'IG_RestKit/ObjectMapping'
  end

  s.subspec 'Testing' do |ts|
    ts.source_files = 'Code/Testing.h', 'Code/Testing'
    ts.dependency 'IG_RestKit/Network'
...
EOS
  ...
  s.subspec 'Search' do |ss|
    ...
    ss.dependency 'IG_RestKit/CoreData'
  end
